...
extension RWFramework {
    ...
    public func getFilteredTagCategories(_ ids: [Int]) -> [TagCategory]? {
    ...
    public func submitListenIDsSetAsTags(streamPatchOptions _: [String: Any] = [:]) {
    ...
    public func getFilterListenIDsSet() -> Set<Int>? {
        if let array = UserDefaults.standard.object(forKey: "filterListenIDsSet") as? [Int] {
            return Set(array)
        } else {
            if let uiconfig = getUIConfig() {
                var set = Set<Int>()
    ...
    public func getSpeakIDsSet() -> Set<Int>? {
        if let array = UserDefaults.standard.object(forKey: "speakIDsSet") as? [Int] {
            return Set(array)
        } else {
            if let uiconfig = getUIConfig() {
                var set = Set<Int>()
